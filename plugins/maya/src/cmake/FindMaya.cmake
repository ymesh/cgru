...
macro(MAYA_SET_PLUGIN_PROPERTIES target)
    ...
    #message ( " *** _maya_DEFINES = " ${_maya_DEFINES} )
endmacro(MAYA_SET_PLUGIN_PROPERTIES)


#SET(MAYA_FOUND FALSE)
set(_maya_TEST_VERSIONS)
set(_maya_KNOWN_VERSIONS "2008" "2009" "2010" "2011" "2012" "2013" "2014" "2015" "2016" "2017" "2018" "2020" "2022" "2023" "2024")
...
if ( MAYA_VERSION STREQUAL "2011" )
    set ( MAYA_QT_VERSION_SHORT "4.5" ) # CACHE STRING 
    set ( MAYA_QT_VERSION_LONG  "4.5.3" )
elseif( MAYA_VERSION STREQUAL "2012" )
    set ( MAYA_QT_VERSION_SHORT "4.7" )
    set ( MAYA_QT_VERSION_LONG  "4.7.1" )
elseif( MAYA_VERSION STREQUAL "2013" )
    set ( MAYA_QT_VERSION_SHORT "4.7" )
    set ( MAYA_QT_VERSION_LONG  "4.7.1" )
elseif ( MAYA_VERSION STREQUAL "2014" )
    set ( MAYA_QT_VERSION_SHORT "4.8" )
    set ( MAYA_QT_VERSION_LONG  "4.8.2" )
elseif( MAYA_VERSION STREQUAL "2015" )
    set ( MAYA_QT_VERSION_SHORT "4.8" )
    set ( MAYA_QT_VERSION_LONG  "4.8.2" )
elseif ( MAYA_VERSION STREQUAL "2016" )
    set ( MAYA_QT_VERSION_SHORT  "4.8" )
    set ( MAYA_QT_VERSION_LONG   "4.8.6" )
elseif ( MAYA_VERSION STREQUAL "2017" )
    set ( MAYA_QT_VERSION_SHORT  "4.8" )
    set ( MAYA_QT_VERSION_LONG   "4.8.6" )
elseif( MAYA_VERSION STREQUAL "2018" )
    set ( MAYA_QT_VERSION_SHORT  "5.6" )
    set ( MAYA_QT_VERSION_LONG   "5.6.1" )
endif()
